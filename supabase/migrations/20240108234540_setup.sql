...
AS $$
DECLARE
  project_url TEXT := 'https://yhcqsfvnoayevfdylwgx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InloY3FzZnZub2F5ZXZmZHlsd2d4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMzU5NjM5NiwiZXhwIjoyMDI5MTcyMzk2fQ.46dynVr1Nb306WoKBArOZOe_fcgZH8s_ZjZQ8Iaaw2g'; -- full access needed for http request to storage
